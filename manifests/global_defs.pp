...
class keepalived::global_defs (
  ...
  Variant[String, Array[String], Undef] $notification_email  = undef,
  ...
  Variant[Boolean, String, Undef] $lvs_flush_onstop   = undef,
  ...
  Variant[Boolean, Integer, Undef] $max_auto_priority = undef,
  ...
  Variant[Boolean, String, Undef] $dynamic_interfaces     = undef,
  ...
  Variant[String, Integer, Undef] $vrrp_rx_bufs_policy    = undef,
  ...
  Variant[Boolean,String, Undef] $umask               = undef,
  Variant[Float, Integer, Undef] $vrrp_startup_delay  = undef,
